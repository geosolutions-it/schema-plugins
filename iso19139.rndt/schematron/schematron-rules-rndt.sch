...
<!-- 	<sch:pattern>
	...
	<sch:pattern>
		...
		|//gmd:MD_Metadata/gmd:identificationInfo/srv:SV_ServiceIdentification">
			<sch:assert test="count(./srv:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox)>0">$loc/strings/alert.M33</sch:assert>
			<sch:assert test="count(./srv:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox)&lt;2">$loc/strings/alert.M33a</sch:assert>
		</sch:rule>
	</sch:pattern>
