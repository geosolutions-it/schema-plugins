  ...
  <xsl:template name="iso19139.rndtCompleteTab">
    ...
    <xsl:call-template name="iso19139CompleteTab">
  	...
  	<xsl:if test="/root/gui/config/metadata-tab/rndt">
  		<xsl:call-template name="displayTab">
  			...
  			<xsl:with-param name="text"    select="/root/gui/strings/rndtTab"/>
  			<xsl:with-param name="tabLink" select="''"/>
  		</xsl:call-template>
  		
  		<xsl:call-template name="displayTab">
  			<xsl:with-param name="tab"     select="'rndtTabDesc'"/>
  			<xsl:with-param name="text"    select="/root/gui/strings/rndtTabDesc"/>
  			<xsl:with-param name="indent"  select="'&#xA0;&#xA0;&#xA0;'"/>
  			<xsl:with-param name="tabLink" select="$tabLink"/>
  		</xsl:call-template>
  		
  		<xsl:call-template name="displayTab">
  			<xsl:with-param name="tab"     select="'rndtTabTech'"/>
  			<xsl:with-param name="text"    select="/root/gui/strings/rndtTabTech"/>
  			<xsl:with-param name="indent"  select="'&#xA0;&#xA0;&#xA0;'"/>
  			<xsl:with-param name="tabLink" select="$tabLink"/>
  		</xsl:call-template>
  		
  		<xsl:call-template name="displayTab">
  			<xsl:with-param name="tab"     select="'rndtTabQua'"/>
  			<xsl:with-param name="text"    select="/root/gui/strings/rndtTabQua"/>
  			<xsl:with-param name="indent"  select="'&#xA0;&#xA0;&#xA0;'"/>
  			<xsl:with-param name="tabLink" select="$tabLink"/>
  		</xsl:call-template>
  		
  		<xsl:call-template name="displayTab">
  			<xsl:with-param name="tab"     select="'rndtTabAcc'"/>
  			<xsl:with-param name="text"    select="/root/gui/strings/rndtTabAcc"/>
  			<xsl:with-param name="indent"  select="'&#xA0;&#xA0;&#xA0;'"/>
  			<xsl:with-param name="tabLink" select="$tabLink"/>
  		</xsl:call-template>
  		
  		<xsl:call-template name="displayTab">
  			<xsl:with-param name="tab"     select="'rndtTabMd'"/>
  			<xsl:with-param name="text"    select="/root/gui/strings/rndtTabMd"/>
  			<xsl:with-param name="indent"  select="'&#xA0;&#xA0;&#xA0;'"/>
  			<xsl:with-param name="tabLink" select="$tabLink"/>
  		</xsl:call-template>
  	</xsl:if>
	...
	<xsl:template name="rndtTabDesc">
		...
		<xsl:call-template name="complexElementGuiWrapper">
			<xsl:with-param name="title" select="/root/gui/strings/rndtTabDesc"/>
			<xsl:with-param name="id" select="generate-id(/root/gui/strings/rndtTabDesc)"/>
	...
	<xsl:template name="rndtTabTech">
		...
		<xsl:call-template name="complexElementGuiWrapper">
			<xsl:with-param name="title" select="/root/gui/strings/rndtTabTech"/>
			<xsl:with-param name="id" select="generate-id(/root/gui/strings/rndtTabTech)"/>
			<xsl:with-param name="content">
	...
	<xsl:template name="rndtTabQua">
		...
		<xsl:call-template name="complexElementGuiWrapper">
			<xsl:with-param name="title" select="/root/gui/strings/rndtTabQua"/>
			<xsl:with-param name="id" select="generate-id(/root/gui/strings/rndtTabQua)"/>
			<xsl:with-param name="content">
	...
	<xsl:template name="rndtTabAcc">
		...
		<xsl:call-template name="complexElementGuiWrapper">
			<xsl:with-param name="title" select="/root/gui/strings/rndtTabAcc"/>
			<xsl:with-param name="id" select="generate-id(/root/gui/strings/rndtTabAcc)"/>
			<xsl:with-param name="content">
	...
	<xsl:template name="rndtTabMd">
		...
		<xsl:call-template name="complexElementGuiWrapper">
			<xsl:with-param name="title" select="/root/gui/strings/rndtTabMd"/>
			<xsl:with-param name="id" select="generate-id(/root/gui/strings/rndtTabMd)"/>
			<xsl:with-param name="content">
