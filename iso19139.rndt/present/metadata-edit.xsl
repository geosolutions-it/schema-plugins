...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="metadata-iso19139.rndtview-simple">
  ...
  <xsl:template name="view-with-header-iso19139.rndt">
    ...
    <xsl:call-template name="view-with-header-iso19139">
  	...
  	<!-- main template - the way into processing iso19139.rndt -->
  <xsl:template match="metadata-iso19139.rndt" name="metadata-iso19139.rndt">
...
<!-- 	<xsl:template name="metadata-iso19139.rndt">
  ...
  <xsl:template name="iso19139.rndtCompleteTab">
    ...
    <xsl:param name="schema"/>
  	...
  	<!-- FRA tabs -->
  	<xsl:if test="/root/gui/config/metadata-tab/rndt">
  		<xsl:call-template name="mainTab">
  			<xsl:with-param name="title" select="/root/gui/schemas/iso19139.rndt/strings/rndtTab"/>
  			<xsl:with-param name="default">rndtTabDesc</xsl:with-param>
  			<xsl:with-param name="menu">
  				<item label="rndtTabDesc">rndtTabDesc</item>
  				<item label="rndtTabTech">rndtTabTech</item>
  				<item label="rndtTabQua">rndtTabQua</item>
  				<item label="rndtTabAcc">rndtTabAcc</item>
  				<item label="rndtTabMd">rndtTabMd</item>
  			</xsl:with-param>
  		</xsl:call-template>
  	</xsl:if>
	...
	<xsl:template mode="iso19139" match="gmd:MD_Metadata|*[@gco:isoType='gmd:MD_Metadata']" priority="2">
		...
		<xsl:choose>
			...
			<!-- fra tab -->
			<xsl:when test="$currTab='rndtTabDesc'">
				<xsl:call-template name="rndtTabDesc">
					<xsl:with-param name="schema" select="$schema"/>
					<xsl:with-param name="edit"   select="$edit"/>
					<xsl:with-param name="dataset" select="$dataset"/>
				</xsl:call-template>
			</xsl:when>
			<xsl:when test="$currTab='rndtTabTech'">
				<xsl:call-template name="rndtTabTech">
					<xsl:with-param name="schema" select="$schema"/>
					<xsl:with-param name="edit"   select="$edit"/>
					<xsl:with-param name="dataset" select="$dataset"/>
				</xsl:call-template>
			</xsl:when>
			<xsl:when test="$currTab='rndtTabQua'">
				<xsl:call-template name="rndtTabQua">
					<xsl:with-param name="schema" select="$schema"/>
					<xsl:with-param name="edit"   select="$edit"/>
					<xsl:with-param name="dataset" select="$dataset"/>
				</xsl:call-template>
			</xsl:when>
			<xsl:when test="$currTab='rndtTabAcc'">
				<xsl:call-template name="rndtTabAcc">
					<xsl:with-param name="schema" select="$schema"/>
					<xsl:with-param name="edit"   select="$edit"/>
					<xsl:with-param name="dataset" select="$dataset"/>
				</xsl:call-template>
			</xsl:when>
			<xsl:when test="$currTab='rndtTabMd'">
				<xsl:call-template name="rndtTabMd">
					<xsl:with-param name="schema" select="$schema"/>
					<xsl:with-param name="edit"   select="$edit"/>
					<xsl:with-param name="dataset" select="$dataset"/>
				</xsl:call-template>
	...
	<xsl:template name="rndtTabDesc">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.rndt/strings/rndtTabDesc"/>
			<xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.rndt/strings/rndtTabDesc)"/>
	...
	<xsl:template name="rndtTabTech">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.rndt/strings/rndtTabTech"/>
		  <xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.rndt/strings/rndtTabTech)"/>
			<xsl:with-param name="content">
	...
	<xsl:template name="rndtTabQua">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.rndt/strings/rndtTabQua"/>
		  <xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.rndt/strings/rndtTabQua)"/>
			<xsl:with-param name="content">
	...
	<xsl:template name="rndtTabAcc">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.rndt/strings/rndtTabAcc"/>
		  <xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.rndt/strings/rndtTabAcc)"/>
			<xsl:with-param name="content">
	...
	<xsl:template name="rndtTabMd">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.rndt/strings/rndtTabMd"/>
		  <xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.rndt/strings/rndtTabMd)"/>
			<xsl:with-param name="content">
